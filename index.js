            ...
            <div class="card-body p-0">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Email: <a href="mailto:man@email.com">man@email.com</a>
                </li>
          ...
          <div class="card m-1 border-dark">
            ...
            <div class="card-body p-0">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Email:
                  <a href="mailto:medlad@email.com">Mediumlad@email.com</a>
                </li>
                <li class="list-group-item">
                  GitHub: <a href="https://github.com/">GithubUsername</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="card m-1 border-dark">
            ...
            <div class="card-body p-0">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Email: <a href="mailto:smol@boi.com">smol@boi.com</a>
                </li>
